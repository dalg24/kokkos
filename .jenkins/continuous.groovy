        ...
        stage('Build-2') {
            parallel {
              // stage('OPENACC-NVHPC-CUDA-12.2') {
               ...
               //                 -DCMAKE_CXX_STANDARD=20 \
               //                 -DCMAKE_CXX_FLAGS="-Werror -Wc,--diag_suppress,177"\
               //                 -DKokkos_ARCH_NATIVE=ON \
               //                 -DKokkos_ENABLE_COMPILER_WARNINGS=ON \
               //                 -DKokkos_ENABLE_TESTS=ON \
                    ...
                    steps {
                        sh '''#!/bin/bash
                              ...
                              /opt/cmake/bin/cmake \
                                ...
                                -DCMAKE_CXX_COMPILER=nvc++ \
                                -DCMAKE_CXX_STANDARD=20 \
                                -DCMAKE_CXX_FLAGS="-Werror -Werror=all-warnings --diag_suppress=implicit_return_from_non_void_function --diag_suppress=177 --diag_remark=177" \
                                -DKokkos_ARCH_NATIVE=ON \
                                -DKokkos_ENABLE_COMPILER_WARNINGS=ON \
                                -DKokkos_ENABLE_DEPRECATED_CODE_5=OFF \
                                -DKokkos_ENABLE_TESTS=ON \
